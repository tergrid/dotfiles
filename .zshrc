...
alias rmr='rm -rf'              # Force delete (be cautious)
...
alias update='sudo apt update && sudo apt upgrade -y' # Update packages (Debian-based)
alias cls='clear'                                     # Clear screen
alias e='exit'                                        # Exit terminal
alias sudo='sudo '                                    # Enable alias expansion with sudo
...
alias k9='kill -9'                                   # Force kill a process
alias top='htop'                                     # Use htop instead of top (if installed)

alias zshconfig="nano ~/.zshrc"  # Open Zsh config
alias reload="source ~/.zshrc"   # Reload Zsh config
alias editrc="$EDITOR ~/.zshrc"  # Open Zsh config with default editor
